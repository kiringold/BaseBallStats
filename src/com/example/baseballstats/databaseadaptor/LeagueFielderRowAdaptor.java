 ...
 * @version 1.0
 */
public class LeagueFielderRowAdaptor extends ArrayAdapter<FielderStatsRow>{
	...
	//コンストラクタ
	public LeagueFielderRowAdaptor(Context context, int ResourceId, List<FielderStatsRow> objects, boolean desc, String click) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(view == null){
			...
			view = inflater.inflate(R.layout.league_fielder_row, null);

			holder = new ViewHolder();

			holder.tv1 = (TextView)view.findViewById(R.id.number_fielder_row);

			holder.tv2 = (TextView)view.findViewById(R.id.name_fielder_row);

			holder.tv3 = (TextView)view.findViewById(R.id.batting_average_fielder_row);

			holder.tv4 = (TextView)view.findViewById(R.id.games_fielder_row);

			holder.tv5 = (TextView)view.findViewById(R.id.plate_appearances_fielder_row);

			holder.tv6 = (TextView)view.findViewById(R.id.at_bats_fielder_row);

			holder.tv7 = (TextView)view.findViewById(R.id.hits_fielder_row);

			holder.tv8 = (TextView)view.findViewById(R.id.double_fielder_row);

			holder.tv9 = (TextView)view.findViewById(R.id.triple_fielder_row);

			holder.tv10 = (TextView)view.findViewById(R.id.home_runs_fielder_row);

			holder.tv11 = (TextView)view.findViewById(R.id.total_bases_fielder_row);

			holder.tv12 = (TextView)view.findViewById(R.id.runs_battend_in_fielder_row);

			holder.tv13 = (TextView)view.findViewById(R.id.runs_fielder_row);

			holder.tv14 = (TextView)view.findViewById(R.id.strikeouts_fielder_row);

			holder.tv15 = (TextView)view.findViewById(R.id.bases_on_balls_fielder_row);

			holder.tv16 = (TextView)view.findViewById(R.id.hit_by_pitch_fielder_row);

			holder.tv17 = (TextView)view.findViewById(R.id.sacrifice_hits_fielder_row);

			holder.tv18 = (TextView)view.findViewById(R.id.sacrifice_flies_fielder_row);

			holder.tv19 = (TextView)view.findViewById(R.id.stolen_bases_fielder_row);

			holder.tv20 = (TextView)view.findViewById(R.id.on_base_percentage_fielder_row);

			holder.tv21 = (TextView)view.findViewById(R.id.slugging_percentage_fielder_row);

			holder.tv22 = (TextView)view.findViewById(R.id.batting_average_with_runners_in_scoring_position_fielder_row);

			holder.tv23 = (TextView)view.findViewById(R.id.game_winning_runs_batted_in_fielder_row);

			holder.tv24 = (TextView)view.findViewById(R.id.double_play_fielder_row);

			holder.tv25 = (TextView)view.findViewById(R.id.errors_fielder_row);

			holder.tv26 = (TextView)view.findViewById(R.id.ops_fielder_row);

			holder.tv27 = (TextView)view.findViewById(R.id.isod_fielder_row);

			holder.tv28 = (TextView)view.findViewById(R.id.team_fielder_row);
		...
		holder.tv28.setText(row.getTeamFielder());
