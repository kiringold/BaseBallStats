...
public class LeaguePitchRowAdaptor extends ArrayAdapter<PitchStatsRow>{
	...
	//LayoutInflater(レイアウトからViewを生成）
			...
			//コンストラクタ
	public LeaguePitchRowAdaptor(Context context, int ResourceId, List<PitchStatsRow> objects , boolean desc, String click) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(view == null){
			...
			view = inflater.inflate(R.layout.league_pitch_row, null);

		holder = new ViewHolder();

		holder.tv1 = (TextView)view.findViewById(R.id.number_pitch_row);

		holder.tv2 = (TextView)view.findViewById(R.id.name_pitch_row);

		holder.tv3 = (TextView)view.findViewById(R.id.earned_run_average_pitch_row);

		holder.tv4 = (TextView)view.findViewById(R.id.games_pitch_row);

		holder.tv5 = (TextView)view.findViewById(R.id.complete_games_pitch_row);

		holder.tv6 = (TextView)view.findViewById(R.id.shutouts_pitch_row);

		holder.tv7 = (TextView)view.findViewById(R.id.no_bb_hbp_pitch_row);

		holder.tv8 = (TextView)view.findViewById(R.id.wins_pitch_row);

		holder.tv9 = (TextView)view.findViewById(R.id.losses_pitch_row);

		holder.tv10 = (TextView)view.findViewById(R.id.holds_pitch_row);

		holder.tv11 = (TextView)view.findViewById(R.id.holds_points_pitch_row);

		holder.tv12 = (TextView)view.findViewById(R.id.saves_pitch_row);

		holder.tv13 = (TextView)view.findViewById(R.id.winning_percentage_pitch_row);

		holder.tv14 = (TextView)view.findViewById(R.id.innings_pitched_pitch_row);

		holder.tv15 = (TextView)view.findViewById(R.id.hits_pitch_row);

		holder.tv16 = (TextView)view.findViewById(R.id.home_runs_pitch_row);

		holder.tv17 = (TextView)view.findViewById(R.id.strikeouts_pitch_row);

		holder.tv18 = (TextView)view.findViewById(R.id.bases_on_balls_pitch_row);

		holder.tv19 = (TextView)view.findViewById(R.id.hit_by_pitch_pitch_row);

		holder.tv20 = (TextView)view.findViewById(R.id.wild_pitches_pitch_row);

		holder.tv21 = (TextView)view.findViewById(R.id.balks_pitch_row);

		holder.tv22 = (TextView)view.findViewById(R.id.runs_pitch_row);

		holder.tv23 = (TextView)view.findViewById(R.id.earned_runs_pitch_row);

		holder.tv24 = (TextView)view.findViewById(R.id.whip_pitch_row);

		holder.tv25 = (TextView)view.findViewById(R.id.k_bb_pitch_row);

		holder.tv26 = (TextView)view.findViewById(R.id.team_pitch_row);
		...
		holder.tv26.setText(row.getTeamPitch());
